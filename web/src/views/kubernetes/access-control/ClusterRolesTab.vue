<template>
  <div class="cluster-roles-tab">
    <div class="search-bar">
      <el-input v-model="searchName" placeholder="搜索 ClusterRole 名称..." clearable @input="handleSearch" class="search-input">
        <template #prefix>
...
import { getClusterRoles, type ClusterRoleInfo } from '@/api/kubernetes'
...
const handleEdit = (row: ClusterRoleInfo) => {
  ElMessage.info('编辑功能开发中...')
}

const handleDelete = (row: ClusterRoleInfo) => {
