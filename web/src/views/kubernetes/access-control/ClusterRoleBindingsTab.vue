<template>
  <div class="cluster-role-bindings-tab">
    <div class="search-bar">
      <el-input v-model="searchName" placeholder="搜索 ClusterRoleBinding 名称..." clearable @input="handleSearch" class="search-input">
        <template #prefix>
...
import { Search, Connection, Edit, Delete } from '@element-plus/icons-vue'
import { getClusterRoleBindings, type ClusterRoleBindingInfo } from '@/api/kubernetes'
...
const handleEdit = (row: ClusterRoleBindingInfo) => {
  ElMessage.info('编辑功能开发中...')
}

const handleDelete = (row: ClusterRoleBindingInfo) => {
